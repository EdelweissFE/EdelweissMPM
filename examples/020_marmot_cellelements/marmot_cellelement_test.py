...
from edelweissmpm.generators import rectangularelementcellgridgenerator
...
def run_sim():
    ...
    rectangularelementcellgridgenerator.generateModelData(
        mpmModel,
        journal,
        x0=0.0,
        l=100.0,
    ...
    allElements = mpmModel.elementSets["all"]
    ...
    nodeFieldOnAllCellElements = mpmModel.nodeFields["displacement"].subset(allElements)
    ...
    try:
        ...
        journal.printPrettyTable(prettyTable, "Performance Summary")
